...
exports.addTiny = async (req, res) => {
    try {
        ...
        res.json({ arrImg, arrNameImg, message: " Images were successfully added!" })
    } catch (error) {
        res.send({ error: error.message })
    }
}
exports.addItem = async (req, res) => {
    try {
        ...
        let listItem = await ItemModel.create({ title: title, content: content, arrNameImg: arrNameImg })
...
exports.deleteItem = async (req, res) => {
    try {
        ...
        res.json({ listItem: nameImg, message: " Items were successfully deleted!" })
    } catch (error) {
        res.send({ error: error.message })
    }
}
exports.updateItem = async (req, res) => {
    try {
        ...
        let listItem = await ItemModel.findByIdAndUpdate(id, { title: title, content: content }, { new: true })
...
exports.searchItem = async (req, res) => {
    try {
        ...
        let listItem = await ItemModel.find({ title: { $regex: textSearch, $options: "i" } })
        res.json({ listItem: listItem, message: "Get Items successfully!" })
    } catch (error) {
        res.send({ error: error.message })
    }
